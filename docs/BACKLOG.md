...
| Axis         | Value                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | Gate                                         |
| ------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------- |
| Source       | ~172 non-test files + ~179 test files; 7 Playwright specs in `tests/e2e/`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | `find app/src -name '*.ts' -o -name '*.tsx'` |
...
| App.tsx      | 12 hooks under `src/App/use*.ts` (Wave 7-D + Waves 17-21 follow-ups); 5 sub-components extracted (`AppHeader`, `AppRedlinePane`, `AppFooterControls`, `AppCurrentPane`, `AppLibraryAndPacksPane`); App.tsx **571 lines** (below the ~600 target)                                                                                                                                                                                                                                                                                                                                                | —                                            |
