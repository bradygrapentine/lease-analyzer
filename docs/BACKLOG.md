...
| Axis         | Value                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | Gate                                         |
| ------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------- |
| Source       | ~182 non-test files + ~153 test files; 7 Playwright specs in `tests/e2e/`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | `find app/src -name '*.ts' -o -name '*.tsx'` |
| Tests        | ~1217 passing (app, post-Wave-26-A) + 8 in `cli/` + 6 e2e (chromium) + 1 gated real-model spec                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | `npm test`                                   |
| Coverage     | thresholds **95 / 89 / 91 / 95** (post-Wave-24-C bump); see `docs/TESTING.md` for current actuals                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | `npm run test:coverage`                      |
